package eu.kanade.tachiyomi.extension.zh.kaimanhua
...
class Kaimanhua : HttpSource() {
    // 和 爱漫画 漫画台 用得同一个连接请求
    override val name = "凯漫画"
    ...
    private var requestImageHeaders = Headers.of(mapOf(
        ...
        "Referer" to "http://m.manhuatai.com/"
    ))
    ...
    private fun mangaFromJSON(json: String): MangasPage {
        ...
        for (i in 0 until arr.length()) {
            ...
            ret.add(SManga.create().apply {
                title = objArr.getString("comic_name")
                thumbnail_url = "http://image.yqmh.com/mh/$comic_id.jpg-600x800.jpg.webp"
                author = objArr.getString("comic_author")
                url = "http://comic.321mh.com/app_api/v5/getcomicinfo_body/?comic_id=$comic_id&from_page=search&platformname=android&productname=kaimh"
            })
        }
    ...
    override fun popularMangaRequest(page: Int): Request {
        return jsonGet("https://getconfig-globalapi.yyhao.com/app_api/v5/getsortlist/?page=$page&size=7&orderby=click&search_key=&young_mode=0&platformname=android&productname=kaimh")
    }
    ...
    override fun latestUpdatesRequest(page: Int): Request {
        return jsonGet("https://getconfig-globalapi.yyhao.com/app_api/v5/getsortlist/?page=$page&size=7&orderby=date&search_key=&young_mode=0&platformname=android&productname=kaimh")
    }
    ...
    override fun searchMangaRequest(page: Int, query: String, filters: FilterList): Request {
        if (query != "") {
            return jsonGet("https://getconfig-globalapi.yyhao.com/app_api/v5/getsortlist/?page=$page&orderby=click&search_type=&comic_sort=&search_key=$query&size=21&young_mode=0&platformname=android&productname=kaimh")
        } else {
            ...
            return jsonGet("https://getconfig-globalapi.yyhao.com/app_api/v5/getsortlist/?page=$page&search_type=&comic_sort=$params&search_key=&platformname=android&productname=kaimh")
        }
    }
